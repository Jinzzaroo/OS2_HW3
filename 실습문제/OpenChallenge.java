...
class Player{
	...
	boolean Succeed() { // 성공 여부 확인
		char lastChar = OpenChallenge.word[0].charAt(OpenChallenge.word[0].length()-1); // 앞서 입력된 단어의 마지막 문자
		char firstChar = OpenChallenge.word[1].charAt(0); // 이번에 입력된 단어의 첫번째 문자
